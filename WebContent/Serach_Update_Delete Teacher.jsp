...
<form action=" " method="post">
    ...
    <h1>Update/Delete Teacher</h1>
    <hr/>
     
      Teacher: <input type = "text" id = "search"/><br/></br>
     
      <input type = "button" class="btn btn-primary" onclick = "show_result()" class = "form-control" value = "search"/>
    ...
    <script>
       ...
       function show_result() {
         ...
         var tid = document.getElementById("search").value;
         var url="ajaxT.jsp?tid=" + tid;
                ...
                if (tid.length == 0) {
                    ...
                    xmlhttp.onreadystatechange = function() {    
                        if (this.readyState == 4 && this.status == 200) {
                          ...
                          document.getElementById("txtHint").innerHTML = "Teacher not found, please retype!!!";
                        }
                    };
