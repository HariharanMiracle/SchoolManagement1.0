...
<html>
 <head>
      <title>Happy Kids | Teacher Registration</title>
      <!-- Meta tags -->
         ...
         <div class="sap_tabs">
            <div id="horizontalTab">
               <ul class="resp-tabs-list">
                  <li class="resp-tab-item"><span>TEACHER REGISTRATION</span></li>
               </ul>
                        ...
                        <form action="Teacher Registration DB.jsp" method="post">
                           ...
                           <div class="main main1 col-md-6">
                              ...
                              <div class="form-left-w3l1">
                                 <input type="text" name="tid" placeholder="Teacher ID" required="">
                              </div>
                              <div class="form-left-w3l1">
                           ...
                           <div class="main2 col-md-6">
                              ...
                              <div class="form-left-w3l1">
                                 <input type="textarea" name="qualification" placeholder="Qualifications / Expierience" required="">
                              </div>
                              <div class="form-left-w3l1">
