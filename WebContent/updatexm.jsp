...
<li><a href="leave.jsp">Leave Request</a></li>    
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<br></br><br><br>
         	<center><div style = "margin-left: 50px; margin-top: -12px;"><h1 style = "color: #5d691c">UPDATE EXAM DATES</h1></div></center>
...
<div class="col-sm-7" style="margin-left:5px">	<br/>
	 <h4>  Student Updated Exam Dates</h4>     
        <table border="1">
                  <tr>
                        <td><center><b>Exam ID</b></center><td><center><b>Subject ID</b></center></td><td><center><b>Exam Date</b></center></td>
                        <td><center><b>Term</b></center></td><td><center><b>Grade</b></center></td>
                        <td><center><b>Choose New Date</b></center></td>
                    </tr>
        <% 
             ...
             try{  
                ...
                <td> <%= rs.getString("id")%></td>
                 ...
                 <td> <%= rs.getString("term")%></td>
                  ...
                  <form action="updatxm" method="POST">
                      <input type="hidden" name="ex_id" value="<%= rs.getString("id") %>" readonly="readonly" />
                      <td> <input type="date" name="dat"></td>
                      

                     <td>  <button style="background-color:greenyellow "class="button"input type="update" name="update" value="update" style="vertical-align:middle"><span>UPDATE </span></button></td>
