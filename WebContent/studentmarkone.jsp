 ...
 <br>
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<br></br><br><br>
 <center><div style = "margin-left: 50px; margin-top: -12px;"><h1 style = "color: #5d691c">Select Grade And Term </h1></div></center>	</div>
	<br>
</header>
<!-- Header section end -->
...
<form action = "studentmarktwo.jsp" method = "post">
