...
<title>Particular Notices</title>
...
<li><a href="leave.jsp">Leave Request</a></li>    
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<a href = "com_tec_not.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Common Notice</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		

		</div>
	<h2>Notice to a particular teacher</h2>
...
<%
	...
	ResultSet rs = st.executeQuery("select * from `send_to` WHERE tid = (SELECT teacher.tid from `teacher` where teacher.uid ='"+uid+"')ORDER BY nid DESC");
	...
	while(rs.next()) {
		...
		if(rs1.next()) {
			...
			%>
				<h4 class = "link_col">Senders ID : <% out.println(sid); %></h4>
				<h4 class = "link_col">Date Send : <% out.println(sdate); %></h4>
				<h4 class = "link_col">Notice : <% out.println(desc); %></h4>
				<hr/>
			<%
