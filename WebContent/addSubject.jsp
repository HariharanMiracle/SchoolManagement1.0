 ...
 <br>
  ...
  <li><a href="adminHome.jsp">Home</a></li> 
    <li><a href="AddUser.jsp">User Management</a></li>
        <li style="background-color:#2aa5d8"><a href="addSubject.jsp">Subject Management</a></li>
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<div style = "margin-left: 2%; background-color: #00FF00; border-radius: 10px;padding-top:10px;padding-bottom:10px ">
			<a href = "ViewSubjectServlet" style = " text-decoration: none; font-size: 20px; color: white;">&nbsp;&nbsp;View Subjects</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href = "addSubject.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Add another</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href = "adminHome.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Reports</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="title" id="t"class="form-control" placeholder="Title" required>
    </div>
  </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="teacher" id="t" class="form-control" placeholder="Teacher" required>
    </div>
  </div>
