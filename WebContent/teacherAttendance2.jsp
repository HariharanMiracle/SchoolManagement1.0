  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<div style = "margin-left: 2%; background-color: #00FF00; border-radius: 10px;padding-top:10px;padding-bottom:10px ">
			<a href = "teacherAttendance2.jsp" style = " text-decoration: none; font-size: 20px; color: white;">&nbsp;&nbsp;Mark Teachers' Attendance</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href = "View_TAttendance.jsp" style = " text-decoration: none; font-size: 20px; color: white;">&nbsp;&nbsp;View Teachers' Attendance</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%	
		...
		ResultSet rs1 = st1.executeQuery("select * from `teacher_attendance` where `date` = '"+str+"'");
	...
	if(!rs1.next()){
		while(rs.next()){	
			...
			<select name = "attendance" id = "stat" onchange = showHint(this.value)>
				...
				<option value = "<% out.println(tid + "absent"); %>">0</option>
				<option value = "<% out.println(tid + "present"); %>">1</option>
			</select>
			</td>
			</tr>
            ...
            function showHint(str) {
            	var url="teacherAttendance1.jsp?str1= " + str;
