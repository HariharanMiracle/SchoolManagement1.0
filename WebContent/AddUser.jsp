  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-3" style="margin-top:20px; float:left">
		...
		<div style = " background-color: #00FA9A; width: 300px; border: 10px solid green; padding: 25px; margin: 25px">
			<a href = "AddStudent.jsp" style = " text-decoration: none; font-size: 20px; color: white;">&nbsp;&nbsp;Add Student <img src="user.jpg" width="50px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
	...
	<div class="col-sm-6" style="margin-top:20px; margin-left:5px">
		...
		<div style = " background-color: #00FA9A; width: 300px; border: 10px solid green; padding: 25px; margin: 25px">
			<a href = "AddTeacher.jsp" style = " text-decoration: none; font-size: 20px; color: white;">&nbsp;&nbsp;Add Teacher <img src="teacher.png" width="50px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
	...
	<div class="col-sm-3" style="margin-top:20px; margin-left:5px">
		...
		<div style = " background-color: #00FA9A; width: 300px; border: 10px solid green; padding: 25px; margin: 25px">
			<a href = "AddStaff.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Add Staff<img src="user.jpg" width="50px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
	</div>
	...
	<div class="col-sm-6" style="margin-top:20px; margin-left:5px">
		...
		<div style = " background-color: #00FA9A; width: 300px; border: 10px solid green; padding: 25px; margin: 25px">
			<a href = "AddAdmin.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Add Admin<img src="user.jpg" width="50px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
