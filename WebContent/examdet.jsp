 ...
 <br>
  <ul>
    ...
    <li ><a href="timetables.jsp">Classroom Routine</a></li>
     <li style="background-color:#2aa5d8"><a href="examdet.jsp">Exams</a></li>
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<br></br><br><br>
			<center><div style = "margin-left: 50px; margin-top: -12px;"><h1 style = "color: #5d691c">EXAM NOTICES </h1></div></center>
        </div>
	<br/>
</header>
<!-- Header section end -->
...
<!-- Mid section start -->
	...
	<br/>
        <table border="1" width="25%" cellpadding="5" align="center">
            <thead> 
               <th colspan="4">Exam Time Table</th>        
            </thead>
                <tbody>
                    <tr>
                        <td><center><b>Exam Id</b></center><td><center><b>Subject</b></center></td><td><center><b>Date</b></center></td>
                        <td><center><b>Term</b></center></td>
                    </tr>
        <% 
             ...
             try{  
                ...
                String sql="SELECT student.stid,student.uid,exam.sid,exam.date,exam.term,student.grade,exam.id FROM student INNER JOIN exam ON student.grade = exam.grade WHERE student.uid= '"+sname+"';";
                 ResultSet rs=st.executeQuery(sql); 
                
                 while(rs.next()){ %>
                   
                <tr>
                    <td> <%= rs.getString("exam.id")%></td>
