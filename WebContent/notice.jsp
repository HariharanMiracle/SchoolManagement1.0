...
<br> 
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<div style = "margin-left: 2%; background-color: #00FF00; border-radius: 10px;padding-top:10px;padding-bottom:10px ">
			...
			<a href = "notice.jsp" style = " text-decoration: none; font-size: 20px; color: white;">Send Notice</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href = "venq.jsp" style = " text-decoration: none; font-size: 20px; color: white;">FAQ</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div style= "margin-left: 20px; margin-right: 20px; margin-top:20px; margin-bottom:20px;padding-top:20px; padding-bottom:40px">
	...
	<br/>
		<a href = "not_p_tec.jsp" class="btn btn-info btn-block"><img src="msg.jpg" height="30px" width="30px"/>&nbsp;&nbsp;&nbsp;&nbsp;Send notice to a particular teacher</a><br/>
		<a href = "not_a_tec.jsp" class = "btn btn-info btn-block"><img src="msg.jpg" height="30px" width="30px"/>&nbsp;&nbsp;&nbsp;&nbsp;Send notice to all teachers</a><br/>
		<a href = "not_p_stud.jsp" class = "btn btn-primary btn-block"><img src="msg.jpg" height="30px" width="30px"/>&nbsp;&nbsp;&nbsp;&nbsp;Send notice to a particular student</a><br/>
		
		<a href = "not_a_stud.jsp" class = "btn btn-primary btn-block"><img src="msg.jpg" height="30px" width="30px"/>&nbsp;&nbsp;&nbsp;&nbsp;Send notice to all students</a><br/> 
		<a href = "not_p_class.jsp" class = "btn btn-success btn-block"><img src="msg.jpg" height="30px" width="30px"/>&nbsp;&nbsp;&nbsp;&nbsp;Send notice to a particular class</a><br/>
	</div>
</div>
