...
<form action="Admin Registration DB.jsp" method="post">
    ...
    <p>Please fill in this form to create an account.</p>
                              ...
                              <div class="form-group row">
                                 <input type="text" name="adminid" placeholder="Admin ID" class = "form-control" required="">
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                 <input type="password" name="adminpass" placeholder="Password" class = "form-control"required="">
                              </div>
