...
<li><a href="leave.jsp">Leave Request</a></li>    
  ...
  <div style="float:right; margin-top:20px">
   ...
   <div class="col-sm-8" style="margin-top:20px">
		...
		<br></br><br><br>
	<center><div style = "margin-left: 50px; margin-top: -12px;"><h1 style = "color: #5d691c">ADD RESULTS - SELECT GRADE AND TERM</h1></div></center>
	</div>
	<br>
</header>
<!-- Header section end -->
...
<br></br>
 ...
 <center><div style= "margin-left: 20px; margin-right: 20px; margin-top:20px; margin-bottom:20px;padding-top:20px; padding-bottom:40px"> 
	...
	<form action="Addmarkstwo.jsp" method="POST">
            <br>
        Grade <select style = "margin-left: 70px; margin-top: -12px;" id="gr" name="grade">
         	 <option>LKG</option>
        	  <option>UKG</option>
                <option>1</option>
                <option>2</option>
             ...
             Term: <select style = "margin-left: 70px; margin-top: -12px;" id="gr" name="trm">
                <option>1</option>
                <option>2</option>
                <option>3</option>
            ...
            <br></br><br></br>
                 <button type = "submit" name = "det" class="button"type="submit" style="vertical-align:middle"><span>SUBMIT </span></button>
                 <br></form>
	</div></center>
	</div>
	</div>
