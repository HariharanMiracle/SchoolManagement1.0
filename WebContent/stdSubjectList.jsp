...
<div style="float:right; margin-top:20px; margin-right:20px">
 ...
 <div class="col-sm-8" style="margin-top:10px">
   	<img src="sub.png" width="60%" style="margin-left:10px" />
   	   ...
   	   <div class="col-sm-8" style="margin-top:5px; margin-left:30px;margin-right:40px; background-color:#E3E7EA">
...
while(rs.next()){
%>
<a href=<%= "\"materialListStd.jsp?ti=" + rs.getString("SubjectID") + "\"" %> ><%=rs.getString("Title")%></a>
...
%>
 ...
 <div class="col-sm-8" style="margin-top:200px">
 					<a href="stdGrades.jsp" class="btn btn-success btn-block" role="button" style="background-color:	#00FF00" >Grades</a>
