	...
	<%	
		...
		if(rs.next()){
			if(!rs1.next()){
				...
				double basic = rs.getDouble(11);
				double ot_Rate = rs.getDouble(12);
				...
				%>
					...
					<a href = "Calculate_Salary.jsp" class="btn btn-primary">Calculate_Salary</a>
				<%			}
			else{
				%>
			...
			<a href = "Calculate_Salary.jsp" class="btn btn-primary">Back</a>
			<%
		}
		%>
