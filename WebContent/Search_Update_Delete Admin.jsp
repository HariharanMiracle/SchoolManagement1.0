...
<form action=" " method="post">
  ...
  <h1>Update/Delete Admin</h1>
    <hr/>
      ...
      Admin:  <input type = "text" id = "search"/><br/></br>
    ...
    <script>
       ...
       function show_result() {
         ...
         var adminid  = document.getElementById("search").value;
         var url="ajaxAdmin.jsp?adminid=" + adminid;
                ...
                if (adminid.length == 0) {
                    ...
                    xmlhttp.onreadystatechange = function() {    
                        if (this.readyState == 4 && this.status == 200) {
                          ...
                          document.getElementById("txtHint").innerHTML ="Admin not found, please retype!!!";
                        }
                    };
